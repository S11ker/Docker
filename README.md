...
Коллекция Docker Compose конфигураций для self-hosted сервисов. Всё настроено для быстрого развертывания популярных инструментов в домашней лаборатории или на небольшом сервере.
